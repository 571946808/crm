...
$(function(){
    ...
    function Pagination(page){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.securityGroupList,
                    ...
                    $.each(rs.list, function(index, item){
                        str += '<tr data-id="'+ item.id +'" data-express="'+ item.express +'" data-description="'+ item.description +'">\
                                    ...
                                    <td>\
                                        ...
                                        <a href="#?id='+ item.id +'" class="label-info"><i class="fa fa-book"></i>&nbsp;查看权限</a>\
                                    </td>\
                                </tr>'
                    }); 
    ...
    function edit(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.editSecurityAuthority,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
    ...
    function add(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.addSecurityAuthority,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
    ...
    function del(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.delSecurityAuthority,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
