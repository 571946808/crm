$(function(){
    ...
    function Inint() {
        $.ajax({
            type: "get",
            url: jQuery.url.AuthorityManagement.sendDicTree,
	...
	function onRemove(e, treeId, treeNode) {
        ...
        $.ajax({
            type: "get",
            url: jQuery.url.AuthorityManagement.delDicTree,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
	...
	function onRename(e, treeId, treeNode, isCancel) {
        ...
        $.ajax({
            type: "get",
            url: jQuery.url.AuthorityManagement.editDicTree,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: data,     //JSON.stringify
            dataType: "json",
            async: false,
	...
	function addHoverDom(treeId, treeNode) {
		...
		if (btn){
			btn.bind("click", function(){
		        ...
		        $.ajax({
		            type: "get",
		            url: jQuery.url.AuthorityManagement.addDicTree,
		            contentType: "application/x-www-form-urlencoded; charset=utf-8",
