...
$(function(){
    ...
    function Pagination(page){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.authorityList,
    ...
    function add(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.addAuthority,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
    ...
    function del(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.AuthorityManagement.delAuthority,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
