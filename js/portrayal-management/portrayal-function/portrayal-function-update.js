...
$(document).ready(function() {
     ...
     */
        ...
        if(labelItemId != -1){
            $.ajax({
                type: "GET",
                url: jQuery.url.PortrayalManagement.radioUpdateData,
     ...
     */
        ...
        jQuery.extend(form, {labelItemId: labelItemList});
        $.ajax({
            type: "GET",
            url: jQuery.url.PortrayalManagement.updateCheckBoxData,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
    ...
    function selectRadio(e){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.PortrayalManagement.updateRadioTagId,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: {labelTypeId: tagId},     //JSON.stringify
            dataType: "json",
            success: function (rs) {
                $(".J_radioSelect").empty();
                var initOption = '<option value="-1" selected="selected">请选择</option>';
    ...
    function radioSelect(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.PortrayalManagement.firstUpdateData,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
    ...
    function selectCheckbox(e){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.PortrayalManagement.updateCheckboxTagId,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: {labelTypeId: tagId},     //JSON.stringify
            dataType: "json",
            success: function (rs) {
    ...
    function checkBoxSelect(){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.PortrayalManagement.firstCheckboxData,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
