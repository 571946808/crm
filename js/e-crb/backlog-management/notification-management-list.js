...
$(function(){
    ...
    function Pagination(page, extraData){
        ...
        $.ajax({
            type: "GET",
            url: jQuery.url.ECRBManagement.notificationList,
            ...
            success: function (rs) {
                ...
                if( rs.code == 0){  
                    $.each(rs.list, function(index, item){
                        str += '<tr data-id="'+ item.eventId +'">\
                                    <td>'+ item.number +'</td>\
                                    <td>'+ item.name +'</td>\
                                    <td>'+ item.type +'</td>\
                                    <td>'+ item.level +'</td>\
                                    <td>'+ item.currentActiveStartTime +'</td>\
                                    <td>'+ item.memberGroupId +'</td>\
                                    <td>'+ item.notificaitonNum +'</td>\
                                    <td>\
                                        <a href="#?id='+ item.eventId +'" class="label-info"><i class="fa fa-book"></i>&nbsp;详情</a>\
                                    </td>\
                                </tr>';
                    }); 
